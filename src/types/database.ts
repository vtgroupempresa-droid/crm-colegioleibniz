  ...
  public: {
    Tables: {
      ...
      dashboard_config: {
        ...
        Relationships: [
          {
            foreignKeyName: 'dashboard_config_created_by_fkey';
            columns: ['created_by'];
            isOneToOne: false;
            referencedRelation: 'user_profiles';
            referencedColumns: ['id'];
      ...
      leads: {
        Row: {
          ...
          automations_blocked_by: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'leads_automations_blocked_by_fkey';
            columns: ['automations_blocked_by'];
            isOneToOne: false;
            referencedRelation: 'user_profiles';
            referencedColumns: ['id'];
          },
          ...
          {
            foreignKeyName: 'leads_qualification_updated_by_fkey';
            columns: ['qualification_updated_by'];
            isOneToOne: false;
            referencedRelation: 'user_profiles';
            referencedColumns: ['id'];
          },
    ...
    Functions: {
      ...
      find_similar_leads_by_name: {
        Args: { min_sim?: number; p_lead_id: string; window_days?: number };
        Returns: {
          b_activity_count: number;
          b_city: string;
          b_created_at: string;
